...
export function About() {
  return (
    <section id="about" className="py-20 dark:bg-gray-950 bg-white ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <p className="text-lg text-gray-700 dark:text-gray-300 text-center leading-relaxed mb-8">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {/* Misión */}
          <div className="bg-linear-to-br from-[#F7FAFC] to-white dark:from-gray-800 dark:to-gray-900 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
            <div className="bg-[#38BDF8] w-16 h-16 rounded-full flex items-center justify-center mb-6">
              <Target className="text-white" size={32} />
            </div>
            <h3 className="text-2xl mb-4 text-[#1A202C] dark:text-white">Nuestra Misión</h3>
          ...
          <div className="bg-linear-to-br from-[#F7FAFC] to-white dark:from-gray-800 dark:to-gray-900 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
            ...
            <h3 className="text-2xl mb-4 text-[#1A202C] dark:text-white">Alcance Global</h3>
            <p className="text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-linear-to-br from-[#F7FAFC] to-white dark:from-gray-800 dark:to-gray-900 p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow border border-gray-200">
            ...
            <h3 className="text-2xl mb-4 text-[#1A202C] dark:text-white">
              Innovación Continua
            </h3>
            <p className="text-gray-700 dark:text-gray-300">
