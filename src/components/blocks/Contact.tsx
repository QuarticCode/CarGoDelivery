...
export function Contact() {
  ...
  return (
    <section
      id="contact"
      className="py-20 bg-linear-to-br from-[#1A202C] to-[#2D3748]"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl mb-4 text-white">Contáctenos</h2>
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white">contacto@cargo-logistics.com</p>
                  </div>
                </div>
            ...
            <div className="bg-[#2D3748] p-6 rounded-xl border border-[#38BDF8]/30">
              <h4 className="text-xl mb-4 text-white">Horario de Atención</h4>
          ...
          <div className="bg-white rounded-2xl p-8 shadow-2xl">
            <h3 className="text-2xl mb-6 text-[#1A202C]">
              Envíanos un Mensaje
            </h3>
